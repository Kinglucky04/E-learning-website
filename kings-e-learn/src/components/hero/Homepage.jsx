import React, { useState } from 'react' // <-- 1. Correctly combined the import
            ...
            <div className="flex flex-col items-center md:items-start justify-center gap-8">
              <div className="text-center md:text-left space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <a href='#web2' className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:shadow-lg transform hover:scale-105 transition-all duration-300 uppercase">
                    Web 2
                  </a>
                  <a href='#web3' className="px-8 py-3 bg-white text-blue-600 font-semibold rounded-lg border-2 border-blue-600 hover:bg-blue-50 transform hover:scale-105 transition-all duration-300 uppercase">
                    web 3
                  </a>
                </div>
